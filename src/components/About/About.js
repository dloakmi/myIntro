        ...
        <Row style={{justifyContent: "center", padding: "10px"}}>
          ...
          >
            <h1 style={{fontSize: "2.1em", paddingBottom: "20px"}}>
              普 通  <strong className="purple"> 研 究 生 </strong>
            </h1>
            <Aboutcard/>
          </Col>
          <Col
            ...
            <ul className="home-about-social-links">
              ...
              <li className="social-icons">
                <a
                    ...
                    className="icon-colour  home-social-icons"
                >
                  <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" version="1.1"
              ...
              <li className="social-icons">
                <a
                    href="https://space.bilibili.com/28645108"
                    target="_blank"
                    rel="noreferrer"
                    className="icon-colour  home-social-icons"
                >
